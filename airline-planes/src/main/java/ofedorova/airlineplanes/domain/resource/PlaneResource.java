...
public class PlaneResource {
    ...
    @PostMapping
    public Mono<ResponseEntity<Void>> newPlane(@Valid @RequestBody PlaneRequest planeRequest, UriComponentsBuilder uriBuilder) {
